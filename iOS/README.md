...
- Nel tab Studio etichetta e spiega lingua originale del file e lingua del risultato tradotto. Mostra durante l'elaborazione una barra persistente con fasi completate, fase corrente e stop; non presentare fasi come percentuale temporale. Il Debug conserva i log fra i riavvii e registra checkpoint durevoli, mentre i modelli di ASR e diarizzazione devono lasciare lo scope prima della fase successiva.
